...
class Boolean_Object(bpy.types.PropertyGroup):
    obj: PointerProperty(name="Boolean Object",type=bpy.types.Object)
...
class PC_Object_Props(PropertyGroup):
    ...
    calculator_index: IntProperty(name="Calculator Index")
    boolean_objects: bpy.props.CollectionProperty(name="Boolean Objects", type=Boolean_Object)
    ...
    def get_geo_node_cage(self):
        if 'GeoNodeName' in self.id_data and self.id_data['GeoNodeName'] == 'GeoNodeCage':
            return pc_types.GeoNodeCage(self.id_data)
