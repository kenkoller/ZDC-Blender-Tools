"""
Universal PBR Shader v1.0.0
============================
A comprehensive PBR shader with full texture map support and optional sparkle system.
...
- Optional three-layer sparkle system (from Metallic Flake Shader)
...
3. Enable "Material: Universal PBR Shader v1.0.0"
