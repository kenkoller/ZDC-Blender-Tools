...
class home_builder_OT_add_wall_snap_line(pc_snap.Drop_Operator):
    ...
    def update_dims(self,wall):
        ...
        self.snap_line.rotation_euler = wall.obj_bp.rotation_euler
        ...
        left_x, left_assembly = self.get_left_collision_location_and_assembly(wall,self.snap_line)
        right_x, right_assembly = self.get_right_collision_location_and_assembly(wall,self.snap_line)
