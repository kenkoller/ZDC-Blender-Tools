...
class Cabinet(pc_types.Assembly):
    ...
    def add_sink(self,category="",assembly_name=""):
        self.sink_appliance = self.add_assembly_from_file(get_sink(category,assembly_name))
    ...
    def add_cooktop(self,category="",assembly_name=""):
        self.cooktop_appliance = self.add_assembly_from_file(get_cooktop(category,assembly_name))
    ...
    def add_range_hood(self,category="",assembly_name=""):
        self.range_hood_appliance = self.add_assembly_from_file(get_range_hood(category,assembly_name))
